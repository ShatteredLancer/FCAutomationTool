...
for (const script of ['scripts/check-fc26-baseline.mjs', 'scripts/build-fc27-preview.mjs', 'scripts/build-fc27-fsu-core.mjs',
  'scripts/build-fc27-fsu-preview.mjs', 'scripts/build-fc27-acceptance.mjs']) {
...
execFileSync(process.execPath, ['node_modules/vitest/vitest.mjs', 'run',
  ...
  'tests/unit/fsu-maintenance-boundary.test.js',
  'tests/unit/fsu-home-init.test.js',
  'tests/unit/fc27-runner-inspection.test.js',
  'tests/unit/fc27-runner-panel.test.js',
  'tests/unit/fc27-fsu-diagnostics.test.js',
  'tests/unit/fc27-challenge-catalog.test.js',
  'tests/unit/fc27-sbc-contract-read.test.js',
  'tests/unit/fc27-traditional-transaction.test.js',
  'tests/unit/fc27-traditional-persistence.test.js',
  'tests/unit/fc27-traditional-provider.test.js',
  'tests/unit/fc27-traditional-recovery.test.js',
  'tests/contracts/fc27-acceptance.test.js',
  'tests/contracts/fc27-production.test.js',
  'tests/unit/fc27-release-packaging.test.js',
  'tests/unit/legacy-hot-reload.test.js',
  'tests/unit/fc27-runner-preview.test.js',
