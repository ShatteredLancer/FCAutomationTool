...
2026-09-18 收尾结果：`27.0.0` 只读首版已正式发布，安装身份、CI、七项 GitHub 资产及 latest 更新地址核验完成。真实 SBC 业务仍延期、Live 仍关闭；下一步只在安全库存具备后开展独立业务验收。证据见 [发布与交付结果](FC27_LIVE_ADAPTATION_ZH.md#发布与交付结果)。
