...
2026-09-18 发布完成：`v27.0.0` / `40463dc` 已推送并发布为只读 latest，FSU Local `26.09.8` 随附；远程 CI 和实际资产/更新下载核验全部通过，Live 不开放。详见 [发布与交付结果](FC27_LIVE_ADAPTATION_ZH.md#发布与交付结果)，下方未发布状态为历史记录。
